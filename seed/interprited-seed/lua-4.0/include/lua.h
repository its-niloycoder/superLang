...
#define LUA_VERSION	"nlang 0.0.0" /* i like this type of naming because of those 0 branch should be pre initial devlopment */
#define LUA_COPYRIGHT	"NO CopyWrite Play with this code, niloy appresiet you."
#define LUA_AUTHORS 	"Currently niloy because i am unmarred\nif a persion get marrade then all things is for wife"
